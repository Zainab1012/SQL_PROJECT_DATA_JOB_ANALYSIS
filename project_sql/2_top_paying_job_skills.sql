...
SQL (6)
R (5)
Tableau, Looker, Excel (3 each)
Power BI, AWS, Pandas (2 each)
If someone wants to become a high-paid data analyst, Python + SQL + R is the strongest technical foundation.
